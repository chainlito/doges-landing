    ...
    <section className="relative">
      ...
      <div className="">
        ...
        <div className=" pt-32  md:pt-40 ">
          <div
            style={{
              backgroundImage: `url(${TopBack.src})`,
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            {/* Section header */}
            <div id="who" className="pb-12 text-center md:pb-16">
              <h1
            ...
            <div
              id="story"
              className="relative aspect-video rounded-2xl  px-5 py-3  before:pointer-events-none before:absolute before:-inset-5 [background-image:linear-gradient(to_bottom,white_73.5%,transparent_26.5%)]"
            >
          ...
          <div
            id="kfeature"
            className=" sm:flex w-full mt-8 text-center md:mt-4 p-8"
          >
            {/* 40% width div */}
          ...
          <div className="w-full mt-8 text-center md:mt-4">
            ...
            <div
              id="community"
              className=" w-full items-center justify-items-center mt-40 text-center pt-80 t-4"
              style={{
